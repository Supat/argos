//
//  TekkiShodanMediumActivityCameraViewController.swift
//  TekkiShodanMediumActivityCameraViewController
//
...
class TekkiShodanMediumActivityCameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private let predictor = TekkiShodanMediumActionClassifier();
