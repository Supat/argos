//
//  TekkiShodanHardActivityCameraViewController.swift
//  TekkiShodanHardActivityCameraViewController
//
...
class TekkiShodanHardActivityCameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private let predictor = TekkiShodanHardActionClassifier();
