//
//  TekkiShodanEasyActivityCameraViewController.swift
//  TekkiShodanEasyActivityCameraViewController
//
//  Created by Supat Saetia on 2021/07/18.
...
class TekkiShodanEasyActivityCameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private let predictor = TekkiShodanEasyActionClassifier();
